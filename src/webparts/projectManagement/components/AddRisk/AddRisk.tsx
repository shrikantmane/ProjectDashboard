...
import { IAddRiskProps } from './IAddRiskProps';
...
export default class AddProject extends React.Component<IAddRiskProps, {
    showPanel: boolean;
    fields: {},
    errors: {},
    errorClass:{},
    ...
    projectSubmit(e) {
        ...
        if (this.handleValidation()) {
            ...
            sp.web.lists.getByTitle("Risks").items.add({
                Description: obj.projectname ? obj.projectname : '',
                Target_x0020_Date: obj.startdate ? new Date(obj.startdate) : '',
               
               AssignedToId: obj.ownername?obj.ownername:'',
    ...
    public render(): React.ReactElement<IAddRiskProps> {
                                                            ...
                                                            <div className="row">
                                                                ...
                                                                <div className="col-lg-6">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <span className="calendar-style"><i className="fas fa-user icon-style"></i>
                                                                            <input ref="ownername" type="text" className={paddingInputStyle + " " + formControl + " " + (this.state.errorClass["ownername"] ? this.state.errorClass["ownername"] : '')} placeholder="Enter name"
                                                                ...
                                                                <div className="col-lg-6">
                                                                    <div className="form-group">
                                                                        ...
                                                                        <input ref="projectdescription" type="text" className={formControl + " " + (this.state.errorClass["projectdescription"] ? this.state.errorClass["projectdescription"] : '')} placeholder="Brief the owner about the project"
