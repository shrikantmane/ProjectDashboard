...
export default class AddProject extends React.Component<IAddTeamProps, {
    ...
    private getProjectByID(id): void {
        ...
        sp.web.lists.getByTitle(this.props.list).items
            ...
            .then((response) => {
                let fields = this.state.fields;
                this.state.fields["duedate"] = response[0].Start_x0020_Date ? new Date(response[0].Start_x0020_Date) : null;
        ...
        this.setState({ fields });
            ...
            sp.web.lists.getByTitle(this.props.list).items.getById(this.props.id).update({
                Team_x0020_MemberId: tempState[0].key,
                 Status:"Active",
                 Start_x0020_Date: obj.duedate ? new Date(obj.duedate).toDateString() : null,
