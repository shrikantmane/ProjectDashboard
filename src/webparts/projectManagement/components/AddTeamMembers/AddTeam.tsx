...
import { IAddTeamProps } from "./IAddTeamProps";
...
> {
  ...
  handleChange(field, e) {
    if (field === "startdate") {
      ...
      this.setState({
        fields,
        cloneProjectChecked: !this.state.cloneProjectChecked
      });
  ...
  private getProjectByID(id): void {
    ...
    sp.web.lists
      ...
      .then(response => {
        let fields = this.state.fields;
        this.state.fields["duedate"] = response[0].Start_x0020_Date
          ? new Date(response[0].Start_x0020_Date)
          : null;
        ...
        if (response[0].Team_x0020_Member) {
          // response[0].Owner.forEach(element => {
          tempSelectedPersona = {
            key: response[0].Team_x0020_Member.ID,
            text: response[0].Team_x0020_Member.Title
          };
  ...
  handleValidation() {
    ...
    if (this.state.currentSelectedItems) {
      ...
      this.props.memberlist.forEach(element => {
        if (
          element.Team_x0020_Member.Title ===
            this.state.currentSelectedItems[0].text &&
    ...
    if (this.handleValidation()) {
      ...
      if (tempState.length > 0) {
        ...
        if (this.props.id) {
          sp.web.lists
            .getByTitle(this.props.list)
            .items.getById(this.props.id)
            .update({
              Team_x0020_MemberId: tempState[0].key,
              Status: "Active",
              Start_x0020_Date: obj.duedate
                ? new Date(obj.duedate).toDateString()
                : null
              //{ results: obj.ownername },
  ...
  public render(): React.ReactElement<IAddTeamProps> {
              ...
              <div className="row">
                <div className="col-sm-12 col-12">
                  {/* <section id="step1">
                                            <div className="well">
                                                <div className="row"> */}
                  <h3 className="hbc-form-header">Team Members</h3>
                  {/* <div > */}
                  <form
                    name="projectform"
                    className="hbc-form"
                    ...
                    <div className="row addSection">
                      <div className="col-sm-12 col-12">
                        <div className="btn-sec">
                          ...
                          <button
                            type="button"
                            className="btn-style btn btn-default"
    ...
    sp.web.siteUsers.get().then(function(data) {
      ...
      data.forEach(persona => {
        ...
        let tempPersona = {
          ...
          imageUrl:
            persona.Email === undefined || persona.Email === ""
              ? null
              : profileUrl
        };
